function [ Pitch_Contour_min, Pitch_Contour_max,Pitch_Contour_mean,pitch_freq ] = pitch_contour_extract( wav_file )
...
figure('Position', [30 30 800 600], 'PaperPositionMode', 'auto', ... 
       ...
       %title('Speech signal waveform');
        subplot(3,1,1); plot(kk,pitch_freq,'.'); title('Pitch Contour obtained by cepstrum pitch estimation method');